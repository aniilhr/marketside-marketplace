"""Django settings for the marketplace platform."""
import os
...
CORS_ALLOW_ALL_ORIGINS = env_bool("CORS_ALLOW_ALL", "1")
...
CELERY_TASK_ALWAYS_EAGER = env_bool("CELERY_EAGER", "1")

EMAIL_BACKEND = os.getenv(
    "EMAIL_BACKEND", "django.core.mail.backends.console.EmailBackend"
)
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "no-reply@marketplace.local")

LOW_STOCK_THRESHOLD = int(os.getenv("LOW_STOCK_THRESHOLD", "10"))
PLATFORM_COMMISSION_PERCENT = float(os.getenv("PLATFORM_COMMISSION_PERCENT", "8"))
